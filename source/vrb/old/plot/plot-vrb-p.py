...
plt.savefig('fig/RMFPT-p1.pdf', format='pdf', transparent=True, bbox_inches="tight")
plt.gcf().clear()
...
plt.savefig('fig/RMFPT-p2.pdf', format='pdf', transparent=True, bbox_inches="tight")
plt.gcf().clear()
...
plt.savefig('fig/RMFPT-p3.pdf', format='pdf', transparent=True, bbox_inches="tight")
plt.gcf().clear()
#plt.show()
#plt.close()
