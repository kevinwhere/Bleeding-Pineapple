...
def taskGeneration_p(numTasks,uTotal,Pmin=1,numLog=2,Ratio=3,sstype="S",seed=1,accessU=0.5,maxUsdQ=1,totRes=5):
	random.seed(seed)
	...
	SSS_generate(accessU,numTasks,maxUsdQ,numCritical)
	AAA_generate(totRes,maxUsdQ,numCritical)
